...
if __name__ == "__main__":
    class Args:
        def __init__(self):
            self.input = "/data/serverF/Codes/detr-main/data/annotations/instances_train2017.json"  # 输入COCO标注文件路径
            self.output = "/data/serverF/Codes/Open-GroundingDino/my_data/annotations/train.jsonl"  # 输出ODVG格式文件路径
            self.idmap = "coco2017"  # 使用COCO2017类别映射
